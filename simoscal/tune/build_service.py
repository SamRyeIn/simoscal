...
none of it is the verification. An embedded client needs the same gates and the
same verdicts, but returned as one machine-readable object a UI (or a bridge, or
a test) reads — not as files a browser opens.
