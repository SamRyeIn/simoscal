...
This is the gate the Quick Edit app runs the instant a user picks files, and its
whole job is to say *no* early and legibly. A wrong byte flashed to the ECU can
