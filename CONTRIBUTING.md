...
because relicensing would need every past contributor's agreement. There is a
companion Android app that is not published yet, and this keeps its licensing an
open question rather than one that gets decided by accident. If that trade isn't
